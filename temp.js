...
async function getUserInput(){ // make async
    const queriedProd = await inquirer.prompt({
        product_name: 'product_name',
        type: 'input', 
        message: 'Hello! Please enter the product you want to search for: '
    })
    productName = queriedProd.product_name;
    return productName; 
}
